...
- **Clone your GitHub repo**
  ...
  ```bash
  git clone https://github.com/kkrishnateja/Production-Ready-Conversational-RAG-Platform-with-LLMOps.git
  ls
  cd Production-Ready-Conversational-RAG-Platform-with-LLMOps
